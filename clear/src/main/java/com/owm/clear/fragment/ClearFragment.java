...
import com.owm.clear.adapter.BigFileAdapter;
...
public class ClearFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void refreshUI() {
        if (mAdapter == null) {
            mAdapter = new BigFileAdapter(data);
    ...
    protected void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case REFRESH_DIR:
                ...
                break;
            case SCAN_START:
                tv_scan_dir.setVisibility(View.VISIBLE);
                tv_scan_dir.setText("");
                break;
            case SCAN_STOP:
                tv_scan_dir.setVisibility(View.GONE);
                break;
        }
    }
